using SolutionTemplate2.BackEnd.Logics.Modules.Administration.ApiCalls.GetApiCalls;
...
namespace SolutionTemplate2.BackEnd.WebApi.Modules.Administration.ApiCalls.GetApiCalls;
