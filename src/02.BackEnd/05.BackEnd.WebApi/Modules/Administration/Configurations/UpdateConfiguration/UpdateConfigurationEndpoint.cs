using SolutionTemplate2.BackEnd.Logics.Modules.Administration.Configurations.UpdateConfiguration;
using SolutionTemplate2.Shared.Dto.Modules.Administration.Configurations;
using SolutionTemplate2.Shared.Dto.Modules.Administration.Configurations.UpdateConfiguration;

namespace SolutionTemplate2.BackEnd.WebApi.Modules.Administration.Configurations.UpdateConfiguration;
