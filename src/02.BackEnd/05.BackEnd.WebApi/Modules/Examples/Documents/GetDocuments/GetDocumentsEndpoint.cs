using SolutionTemplate2.BackEnd.Logics.Modules.Examples.Documents.GetDocuments;
...
namespace SolutionTemplate2.BackEnd.WebApi.Modules.Examples.Documents.GetDocuments;
