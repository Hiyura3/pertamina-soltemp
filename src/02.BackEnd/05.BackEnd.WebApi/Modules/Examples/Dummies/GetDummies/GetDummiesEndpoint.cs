using SolutionTemplate2.BackEnd.Logics.Modules.Examples.Dummies.GetDummies;
...
namespace SolutionTemplate2.BackEnd.WebApi.Modules.Examples.Dummies.GetDummies;
