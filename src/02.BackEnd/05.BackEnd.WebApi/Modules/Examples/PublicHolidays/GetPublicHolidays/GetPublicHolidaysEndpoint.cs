using SolutionTemplate2.BackEnd.Logics.Modules.Examples.PublicHolidays.GetPublicHolidays;
...
namespace SolutionTemplate2.BackEnd.WebApi.Modules.Examples.PublicHolidays.GetPublicHolidays;
