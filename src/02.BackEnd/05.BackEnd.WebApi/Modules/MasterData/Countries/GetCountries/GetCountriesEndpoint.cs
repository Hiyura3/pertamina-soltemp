using SolutionTemplate2.BackEnd.Logics.Modules.MasterData.Countries.GetCountries;
...
namespace SolutionTemplate2.BackEnd.WebApi.Modules.MasterData.Countries.GetCountries;
