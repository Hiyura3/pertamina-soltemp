using SolutionTemplate2.FrontEnd.Logics.Modules.Administration.Audits.GetAudits;
using SolutionTemplate2.Shared.Dto.Modules.Administration.Audits.GetAudits;

namespace SolutionTemplate2.FrontEnd.WebUi.Modules.Administration.Features.Audits.Pages;
