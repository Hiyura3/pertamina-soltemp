using SolutionTemplate2.FrontEnd.Logics.Modules.Administration.Configurations.DeleteConfiguration;
using SolutionTemplate2.FrontEnd.Logics.Modules.Administration.Configurations.GetConfigurations;
using SolutionTemplate2.FrontEnd.Logics.Modules.Administration.Configurations.UpdateConfiguration;
using SolutionTemplate2.FrontEnd.WebUi.Modules.Administration.Features.Configurations.Components;
using SolutionTemplate2.Shared.Dto.Modules.Administration.Configurations.GetConfigurations;

namespace SolutionTemplate2.FrontEnd.WebUi.Modules.Administration.Features.Configurations.Pages;
