using SolutionTemplate2.FrontEnd.Logics.Modules.Examples.Documents.UpdateDocument;

namespace SolutionTemplate2.FrontEnd.WebUi.Modules.Examples.Features.Documents.Components;
