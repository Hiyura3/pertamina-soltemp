using SolutionTemplate2.FrontEnd.Logics.Modules.Examples.Documents.DeleteDocument;
using SolutionTemplate2.FrontEnd.Logics.Modules.Examples.Documents.GetDocument;
using SolutionTemplate2.FrontEnd.WebUi.Modules.Examples.Features.Documents.Components;
using SolutionTemplate2.Shared.Dto.Modules.Examples.Documents.GetDocument;

namespace SolutionTemplate2.FrontEnd.WebUi.Modules.Examples.Features.Documents.Pages;
