using SolutionTemplate2.FrontEnd.Logics.Modules.Examples.Dummies.GetDummies;
using SolutionTemplate2.Shared.Dto.Modules.Examples.Dummies.GetDummies;

namespace SolutionTemplate2.FrontEnd.WebUi.Modules.Examples.Features.Dummies.Pages;
