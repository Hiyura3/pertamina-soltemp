using SolutionTemplate2.FrontEnd.Logics.Modules.Examples.Emails.SendEmailWithTemplate;
using SolutionTemplate2.Shared.Dto.Modules.Examples.Emails.SendEmailWithTemplate;

namespace SolutionTemplate2.FrontEnd.WebUi.Modules.Examples.Features.Emails.Pages;
