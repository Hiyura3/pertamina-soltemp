using SolutionTemplate2.FrontEnd.Logics.Modules.MasterData.Countries.GetCountries;
using SolutionTemplate2.FrontEnd.Logics.Modules.MasterData.Countries.GetCountry;
using SolutionTemplate2.FrontEnd.Logics.Modules.MasterData.Countries.UpdateCountry;
using SolutionTemplate2.FrontEnd.WebUi.Modules.MasterData.Features.Countries.Components;
using SolutionTemplate2.Shared.Dto.Modules.MasterData.Countries.GetCountries;

namespace SolutionTemplate2.FrontEnd.WebUi.Modules.MasterData.Features.Countries.Pages;
